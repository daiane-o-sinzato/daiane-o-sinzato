...
<body>
  <header>
    ...
    <div class="links">
      ...
      <a href="#" target="_blank">📊 Portfólio (em construção)</a>
    </div>
  </header>
  ...
  <main>
    <section id="about">
      ...
      <p>Tenho mais de 10 anos de experiência combinando atendimento, gestão e supply chain. Gosto de unir <strong>olhar analítico + execução rápida</strong> para transformar gargalos em sistemas funcionais — de planilhas inteligentes a painéis integrados via API.</p>
      <ul>
  ...
  <footer>
    <p>Feito com ❤️ por Daiane Sinzato | <a href="mailto:daianesinzato@gmail.com">Entre em contato</a></p>
  </footer>
</body>
</html>